  ...
  <style>
    ...
    *{box-sizing:border-box;scroll-behavior:smooth}
    html,body{
      ...
      margin:0;
      background:
        radial-gradient(1200px 700px at 10% 10%, rgba(255,101,132,0.06), transparent 8%),
        radial-gradient(900px 500px at 90% 90%, rgba(78,144,255,0.04), transparent 8%),
    ...
    body{ background-size: 400% 400%; animation: bgShift 12s ease infinite; }
    ...
    .card{
      width:min(980px,96%);
      background:linear-gradient(180deg, rgba(11,18,32,0.9), rgba(255,255,255,0.02));
      border-radius:18px;
      padding:28px;
    ...
    .heartIcon{ font-size:18px; color:var(--accent); text-shadow: 0 2px 6px rgba(255,101,132,0.25); }
